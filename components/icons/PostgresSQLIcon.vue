<template>
    <Icon viewBox="432.1 445.4">
        <g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="12.5">
            <path
                fill="#000"
                stroke="#000"
                stroke-linecap="butt"
            ...
            />
            <path
                d="M215.9 286.5c-1.4 49.5.3 99.4 5.2 111.5 4.8 12.1 15.2 35.7 50.9 28 29.8-6.4 40.6-18.7 45.3-46 3.5-20.1 10.2-75.9 11-87.3M173.1 38.3s-161.5-66-154 84c1.6 32 45.8 241.7 98.5 178.4 19.2-23.2 36.6-41.4 36.6-41.4M260.3 26.2c-5.5 1.8 89.9-34.9 144.1 34.4 19.2 24.5-3 124.5-56.1 203.4"
            />
            <path
            ...
            />
            <path
                d="M188.6 274.3c-13.6 15.2-9.6 17.9-36.7 23.5-27.5 5.6-11.3 15.7-.8 18.3 12.8 3.2 42.3 7.7 62.3-20.2 6-8.5 0-22.1-8.4-25.6-4-1.6-9.5-3.7-16.4 4z"
            />
            <path
                d="M187.7 274c-1.4-8.8 3-19.5 7.6-31.9 6.9-18.6 22.8-37.2 10-96.3-9.5-44-73.3-9.2-73.4-3.2 0 6 3 30.3-1 58.5-5.2 37 23.5 68.2 56.4 65"
            />
            <path
                fill="#fff"
                stroke-linecap="butt"
