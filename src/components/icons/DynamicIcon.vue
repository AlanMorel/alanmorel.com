...
<script>
    ...
    import StylusIcon from "@/components/icons/StylusIcon";
    import HandlebarsIcon from "@/components/icons/HandlebarsIcon";
    import GameBoyAdvanceIcon from "@/components/icons/GameBoyAdvanceIcon";
