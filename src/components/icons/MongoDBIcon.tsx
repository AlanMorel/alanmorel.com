...
export default function MongoDBIcon(): ReactElement {
    return (
        <Icon viewBox="48 48">
            <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="0" x1="24.2" x2="25.627" y1="47.593" y2="0">
                    <stop stopColor="#54a44d" />
                    <stop offset="1" stopColor="#469747" />
                </linearGradient>
            </defs>
            <circle cx="24" cy="24" fill="url(#0)" r="24" />
            <g fill="#3a5821" transform="matrix(.05078 0 0 .05078 10 10)">
