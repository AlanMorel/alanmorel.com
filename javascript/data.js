var data = {
    ...
    projects: {
        "trumpulse": {
            ...
            color: "#ffffff",
            date: "April 2017",
            description: "Trumpulse uses data from multiple news sources so you can get the pulse of America under Trump. It is a single-page application built using Angular. Using data from various news sources and social networks like Facebook and Twitter, you can get a diverse picture of the state of America under the Trump administration.",
        ...
        "wavewarriors": {
            ...
            color: "#000000",
            date: "December 2015",
            description: "WaveWarriors is a local multiplayer zombie-style survival game played using Xbox Controllers. Play for as long as you can as the waves of enemies get larger, faster and stronger. Various power ups are scattered around the place to aid in your survival. It supports up to 4 players so grab a few friends, connect your controllers and start working together!",
            images: ["image1", "image2", "image3"],
